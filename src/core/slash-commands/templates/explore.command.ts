...
export function getExploreSlashCommand(): SlashCommandTemplate {
  return {
    ...
    instructions: dedent`
      ...
      **Input**: The argument after \`/desx:explore\` is whatever the user wants to think about. Could be:
      - A vague idea: "real-time collaboration UI"
      - A specific problem: "the settings page is getting cluttered"
      - A change name: "add-comments" (to explore in context of that change)
      - A comparison: "modal vs full-page form for sign up"
      ...
      **User is stuck mid-design:**
      \`\`\`
      User: /desx:explore add-sign-up
            I'm not sure if sign up should be a modal or a full page
